...
export default function Project({ name, link }) {
    return (
        <main className="h-72 w-72 flex items-center justify-center">
            ...
            <div className="group w-fit h-fit grid rounded-3xl border-4 border-grape bg-stone hover:border-2 hover:scale-125 z-0 hover:z-10 duration-1000">
                ...
                <div className="grid group-hover:m-4 duration-1000">
                    ...
                    <div className="h-64 w-64 relative rounded-3xl border-grape">
                        <Link href={link}>
                            <Image
                    ...
                    <div className="h-0 scale-0 group-hover:h-4 group-hover:scale-100 group-hover:mt-4 duration-1000">
                        <h4 className="text-center text-black font-medium text-lg -mt-2 opacity-0 group-hover:opacity-100 group-hover:delay-300 duration-300">{name}</h4>
                    </div>
